    ...
    <div className="flex h-screen bg-onboarding-bg">
      <div className="m-auto text-center">
        ...
        <div className="py-8 px-10 mt-10 columns-3">
          <div
            className={`rounded-3xl text-center p-8 ${accessControl === "token"
          ...
          <div
            className={`rounded-3xl text-center p-8 ${accessControl === "nft"
                ? "text-l-slateblue-primary bg-l-slateblue-700"
                : "text-l-slateblue-700 bg-l-slateblue-primary"
              }`}
          ...
          <div
            className={`rounded-3xl text-center p-8 ${accessControl === "addresses"
                ? "text-l-slateblue-primary bg-l-slateblue-700"
                : "text-l-slateblue-700 bg-l-slateblue-primary"
              }`}
